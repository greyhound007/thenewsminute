...
ActiveRecord::Schema.define(:version => 20140204041142) do

  create_table "refinery_base_page_redirects", :force => true do |t|
  ...
  create_table "refinery_topstories", :force => true do |t|
    t.string   "main_headline"
    t.integer  "main_photo_id"
    t.string   "main_blurb"
    t.string   "main_link"
