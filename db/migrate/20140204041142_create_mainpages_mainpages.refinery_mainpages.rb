# This migration comes from refinery_mainpages (originally 1)
class CreateMainpagesMainpages < ActiveRecord::Migration

  def up
    create_table :refinery_mainpages do |t|
  ...
  def down
    if defined?(::Refinery::UserPlugin)
      ::Refinery::UserPlugin.destroy_all({:name => "refinerycms-mainpages"})
    end

    if defined?(::Refinery::Page)
      ::Refinery::Page.delete_all({:link_url => "/mainpages/mainpages"})
    end

    drop_table :refinery_mainpages
