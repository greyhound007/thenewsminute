module Refinery
  module Finances
    class FinancesController < ::ApplicationController
      ...
      before_filter :find_all_finances
      before_filter :find_page

      def index
        # you can use meta fields from your model instead (e.g. browser_title)
        # by swapping @page for @finance in the line below:
        present(@page)
          @politic=Refinery::Finances::Finance.order('position ASC')
    ...
    protected
      ...
      def find_all_finances
        @finances = Finance.order('position ASC')
      end

      def find_page
        @page = ::Refinery::Page.where(:link_url => "/finances").first
      end
