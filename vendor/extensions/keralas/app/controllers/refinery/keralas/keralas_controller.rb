module Refinery
  module Keralas
    class KeralasController < ::ApplicationController

      before_filter :find_all_keralas
      before_filter :find_page

      def index
        # you can use meta fields from your model instead (e.g. browser_title)
        # by swapping @page for @kerala in the line below:
        present(@page)
          @politic=Refinery::Keralas::Kerala.order('position DESC')
    ...
    protected
      ...
      def find_all_keralas
        @keralas = Kerala.order('position ASC')
      end

      def find_page
        @page = ::Refinery::Page.where(:link_url => "/keralas").first
      end
