module Refinery
  module Tamils
    class TamilsController < ::ApplicationController

      before_filter :find_all_tamils
    ...
    protected
      ...
      def find_all_tamils
        @tamils = Tamil.order('position ASC')
      end

      def find_page
        @page = ::Refinery::Page.where(:link_url => "/tamils").first
      end
