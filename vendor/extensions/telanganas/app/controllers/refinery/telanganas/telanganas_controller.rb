module Refinery
  module Telanganas
    class TelanganasController < ::ApplicationController

      before_filter :find_all_telanganas
      before_filter :find_page

      def index
        # you can use meta fields from your model instead (e.g. browser_title)
        # by swapping @page for @telangana in the line below:
        present(@page)
          @politic=Refinery::Telanganas::Telangana.order('position DESC')
      ...
      def show
        @telangana = Telangana.find(params[:id])
    ...
    protected
      ...
      def find_all_telanganas
        @telanganas = Telangana.order('position ASC')
      end

      def find_page
        @page = ::Refinery::Page.where(:link_url => "/telanganas").first
      end
